				...
				<ul class="nav ace-nav">
					...
					<li class="light-blue"><a data-toggle="dropdown" href="#"
						...
						<ul
							...
							<li><a href="user/myZiLiao.do" target="mainframe"> <i class="icon-user"></i>
									个人资料
							</a></li>

							<li class="divider"></li>

							<li><a href="user/exit.do"> <i class="icon-off"></i> 退出
							</a></li>
						</ul></li>
				</ul>
				<!-- /.ace-nav -->
		...
		<div class="main-container-inner">
			...
			<div class="sidebar" id="sidebar">
				...
				<ul class="nav nav-list">
					<li class="active"><a href="salary/highchair.do" target="mainframe">
							<i class="icon-dashboard"></i> <span class="menu-text">
								控制台 </span>
					</a></li>
					<li>
					<c:forEach var="list" items="${list }">
						<c:if test="${list.prent_menu_id==0 }">
						<a href="javascript:void(0)" target="mainframe"
						class="dropdown-toggle"> <i class="icon-desktop"></i> <span
							class="menu-text"> ${list.menu_name} </span> <b class="arrow icon-angle-down"></b>
					</a>
						</c:if>
					
						<ul class="submenu">
							<c:forEach var="list1" items="${list1 }">
								<c:if test="${list1.prent_menu_id==list.menu_id }">
							<li><a href="${list1.menu_url }" target="mainframe"> <i
									class="icon-double-angle-right"></i> ${list1.menu_name }
							</a></li>
							</c:if>
							</c:forEach>
						</ul>
