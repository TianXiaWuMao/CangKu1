...
<body>
	...
	<form action="expense/likeJL.do" method="post" id="f1" class="form-inline">
		...
		<div class="row" style="padding: 15px;">
			<table class="table ">
				...
				<c:if test="${list.expense_state=='0'}">
				<tr>
					...
					<th><a href="expense/JShenHe.do?expense_id=${list.expense_id }">审核</a></th>
				</tr>
				</c:if>
				</c:forEach>
			</table>
